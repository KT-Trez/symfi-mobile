  ...
  return (
    <HStack justifyContent={'space-between'} m={1} p={2} w={'100%'}>
      <Box position={'relative'} style={{ aspectRatio: 16 / 9 }}>
        ...
        {!coverUri && <Overlay bottom={2} right={2} size={'xs'} text={'PLACEHOLDER'} />}
      </Box>

      <Button.Group direction={'column'} w={'1/3'}>
        <Button onPress={onEdit} startIcon={<Icon as={MaterialCommunityIcons} name={'pencil-outline'} size={6} />}>
          Edit
        </Button>
        <Button
          disabled={!coverUri}
          ...
          startIcon={<Icon as={MaterialCommunityIcons} name={'delete-forever-outline'} size={6} />}
        >
          Delete
        </Button>
      </Button.Group>
