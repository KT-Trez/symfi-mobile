...
function List() {
  ...
  // const [sort, setSort] = useState<{ ascending: boolean, type: 'author' | 'date' | 'duration' | 'title' } |
  // null>(null);
  ...
  return (
    <>
      ...
      <SongActions close={closeActions} isOpen={!!actionsFor} refreshSongsList={refreshSongs} songId={actionsFor} />
    </>
  );
}
