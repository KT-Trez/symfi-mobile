...
function PlayListContent() {
  ...
  const getSongs = useCallback(async () => {
    const songArr: SongC[] = [];
    const playListItems = (await Store.songPlayLists.findAsync({
  ...
  return (
    <>
      ...
      {/*<AudioPlayer shows={closeAudioPlayer} tracks={songs.map(song => new TrackAdapter(song))}/>*/}

      {isSongsAdderOpen && (
        <SongsAdder
          close={closeSongsAdder}
          playListID={playlistID}
